...
public class ImportantVariable {
	 ...
	 */
	public static final String HOST_BD_FAC ="10.40.128.23:5432/";
	
	public static final String USER_BD_FAC ="y2020l3i_e_zbaril";
	
	public static final String BD_NAME_BD_FAC ="db2020l3i_e_zbaril";
	
	public static final String PASSWORD_BD_FAC ="A123456*";
	
	
	/**
	 * connexion à ma BD personnelle
	 */
	public static final String HOST_BD_RESEAU ="localhost/";
	
	public static final String USER_BD_RESEAU ="etu";
	
	public static final String BD_NAME_BD_RESEAU ="db_reseau_projet";
	
	public static final String PASSWORD_BD_RESEAU ="A123456*";
